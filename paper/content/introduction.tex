...
Assuming the expected data matrix is sparse, \(\ell_1\)-norm minimization is able to reconstruct highly compressed signals with exceptional accuracy [FIXME].
\newline
\par
Early literature extends this approach to single-lead electrocardiograms (ECG). Although these signals are not inherently sparse in the time domain, Mishra et al. exploit sparsity in the wavelet domain by considering the data as the product of a wavelet basis and a sparse coefficient vector [FIXME].
